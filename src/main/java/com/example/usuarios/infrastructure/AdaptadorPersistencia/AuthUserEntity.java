...
/**
 * Entidad JPA para persistencia de usuarios de autenticación.
 * Implementa UserDetails de Spring Security para integración directa.
 * Principio SOLID: Single Responsibility - Solo maneja la persistencia.
 */
@Entity
...
public class AuthUserEntity implements UserDetails {
    ...
    public AuthUserEntity(UUID id, String email, String password, String nombre, Role role, boolean activo) {
        this.id = id;
        this.email = email;
